...
<table width="571" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr bgcolor="#DF5A0B">
    <td colspan="3"><div class="style1" id="winhosting">
      <div align="center" class="style2">Mesajınız Kayd Edildi. </div>
    </div></td>
    </tr>
    <tr>
      <td colspan="2"><div align="center" class="style1">
        <div align="center">Mesajınız BAŞARIYLA Kayd Edildi.<br/>En Kısa Zamanda Destek Personelimiz Tarafından Yanıtlanacaktır.. <br/>
          <a href="destek.asp">Buraya Tıklayarak Mesajınızı Görebilirsiniz...</a></div>
      </div>        </td>
      </tr>
</tbody></table>
<%
