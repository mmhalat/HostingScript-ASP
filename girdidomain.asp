...
<table width="508" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="5" colspan="5"><div id="winhosting"><img src="resimler/doaktif.gif" /><img src="resimler/yardim.png" class="Tips2" title="Aktif Domainler::Ödemesi Yapılmış Ve Aktive Edilmiş Domainleriniz Listelenmektedir, Aktif Edilmiş Herhangi Bir Domaininiz Yoksa Boş Görünecektir." /></div></td>
    </tr>
    <tr>
      <td colspan="5"><img src="resimler/yatay-cizgi.png" width="500" height="3" /></td>
      </tr>
    <tr>
      <td><span class="style1">Domain Adı </span></td>
      <td><strong>Son Ödeme Tarihi</strong></td>
      <td class="style1">Ödenen Tutar</td>
      <td><strong>Uzat</strong></td>
    </tr>
	<%
set eklerim=server.CreateObject("adodb.recordset")
sql="SELECT * FROM domainler WHERE onayid=" & session("uyeid") & " and paketonay=true"
...
%>
    <tr>
      <td width="125"><a href="dnsduzenle.asp?id=<%=eklerim("id")%>"><%=eklerim("domainadi")%></a></td>
      <td width="125"><%=eklerim("sonodemetarihi")%></td>
      <td width="125"><%=eklerim("odenentutar")%> YTL</td>
      <td width="133"><a href="uzat.asp">Uzatma Bildirimi Yap</a></td>
    </tr>
	<%eklerim.movenext%>
<% next%>
...
<table width="508" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="9" colspan="5"><div id="winhosting"><img src="resimler/doaktifbekleyen.gif" /><img src="resimler/yardim.png" class="Tips2" title="Ödeme Bekleyen Domainler::Siparişini Verdiğiniz Ama Henüz Ödemesini Yapmadığınız Domainler Listeleniyor, Banka Hesaplarımızdan Herhangi Birine 'Ödenecek Tutar' ı Havale Ettikten Sonra 'Ödeme Bildirimi' Yapiniz,Ödemeniz Onaylandığı Takdirde Reseller Paketiniz Personelimiz Tarafından Aktif Hale Getirilecek Ve Mail Adresinize Gerekli Bilgiler Gönderilecektir." /></div></td>
    </tr>
    <tr>
      <td colspan="5"><img src="resimler/yatay-cizgi.png" width="500" height="3" /></td>
      </tr>
    <tr>
      ...
      <td class="style1">Tescili İstenen Süre </td>
...
%>
    <tr>
      <td width="125"><%=eklerim2("domainadi")%></td>
      <td width="125"><%=eklerim2("odenentutar")%> YTL </td>
      <td width="125"><%=eklerim2("tescilsuresi")%>Yıl</td>
      <td width="133"><a href="do-ode.asp?id=<%=eklerim2("id")%>">Ödeme Bildirimi Yap </a></td>
    </tr>
	<%eklerim2.movenext%>
<%next%>
