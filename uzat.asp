...
if eklerim.eof then 
response.Write("Henüz Herhangi Bir Sipariş Vermediniz...")
else
eklerim.pagesize = 15
...
%>
    <tr>
      ...
      <td width="96"><%=eklerim("odenentutar")%></td>
      <td width="313"> <a href="do-ode.asp?id=<%=eklerim("id")%>">Uzatma Bildirimi Yap </a></td>
    </tr>
	<%eklerim.movenext%>
<% next
	end if %><%
...
%>
    <tr>
      ...
      <td width="96"><%=paketim("odenentutar")%></td>
      <td width="313"><a href="pakode.asp?id=<%=paketim("paketid")%>">Uzatma Bildirimi Yap </a></td>
    </tr>
	<%paketim.movenext%>
<% next
	end if %><%
	if resellerim.eof then 
response.Write("Henüz Herhangi Bir Sipariş Vermediniz...")
else
...
%>
    <tr>
      ...
      <td width="96"><%=resellerim("odenentutar")%></td>
      <td width="313"><a href="resode.asp?id=<%=resellerim("paketid")%>">Uzatma Bildirimi Yap. </a></td>
    </tr>
	<%resellerim.movenext%>
<% next
	end if %>
