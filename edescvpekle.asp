...
<form action="edescvpkaydet.asp?id=<%=request.QueryString("id")%>" method="post"><table width="571" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr bgcolor="#DF5A0B">
    <td colspan="3"><div class="style1" id="winhosting">
      <div align="center" class="style2"><%=request.QueryString("id")%> Numaralı Edestek Mesajına Cevabınız.</div>
    </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="300" class="style1"><input type="submit" name="Submit2" value="Mesajı Gönder" /></td>
    </tr>
</tbody></table>
</form>
	<br>
