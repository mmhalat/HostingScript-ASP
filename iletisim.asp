...
<table width="555" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#DF5A0B"><div align="center" class="style1 style2">İletişim</div></td>
  </tr>
  <tr>
    <td height="98">
	  ...
	  <div align="center">
	    <p align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AyyildizSoFT 2007 Yılında Türkiyenin Kayseri İlinde Faliyete Girmiş Ve Günümüze Kadarda Kendini Hem Daha ileriye Götürmüş Hemde Müşteri Kitlesini Artırarak Yoluna Emin Adımlarla Devam Etmiştir. <br />
  <br />
  Telefon : 0554 778 79 63 (7/24)  <br />
  Elektronik Posta Adresimiz: iletisim@ayyildizsoft.com<br />
        </p>
	    <p align="left"><a href="edestek.asp" target="_blank" onClick='window.open("edestek.asp","_blank","width=170,height=280,status=yes,scrollbars=0,resizable=1");return false;'>Online Görüşme İçin Tıklayın.</a></p>
	    <p align="left">Messenger : Destek@AyyildizSoFT.Com </p>
	  </div>
