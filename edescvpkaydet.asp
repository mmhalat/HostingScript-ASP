...
<%
if icerik="" then
response.Write("<center>Bazı Alanları Boş Bıraktınız/</center>")
else
%>
  ...
  <tbody><tr bgcolor="#DF5A0B">
    ...
    <tr>
      <td colspan="2"><div align="center" class="style1">
        <div align="center">Mesajınız BAŞARIYLA Kayd Edildi.<br/>
          En Kısa Zamanda Destek Personelimiz Tarafından Yanıtlanacaktır.. </div>
      </div>        </td>
      </tr>
</tbody></table>
<%
