...
<table width="430" border="0" align="center" cellpadding="0" cellspacing="1">
  ...
  <tr bgcolor="#F4F4F4">
    <td colspan="2"><div align="right" class="style1">
      <div align="left">Mesaj İçeriği: </div>
    </div>      </td>
    </tr>
  <tr bgcolor="#F4F4F4">
    <td colspan="2"><div align="right"></div>      <div align="center"><%=detay("kampanya")%></div></td>
    </tr>
  <tr bgcolor="#F4F4F4">
  ...
  <tr bgcolor="#F4F4F4">
    <td><div align="right" class="style1">İlgili Departman:</div></td>
    <td width="325"><%=detay("ilgili")%></td>
  </tr>
  <tr bgcolor="#F4F4F4">
    <td><div align="right" class="style1">Bitiş Tarihi: </div></td>
    <td><%=detay("son_tarih")%>&nbsp;</td>
  </tr>
</table>
<div align="left"><br>
</div>
