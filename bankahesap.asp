...
<table width="555" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="4" bgcolor="#DF5A0B"><div align="center" class="style1 style2">Banka Numaralarımız </div></td>
  </tr>
  <tr>
    <td width="158" height="7" rowspan="4">
	
	
	  <div align="center">
	    <p align="left"><img src="resimler/akbank.png" width="158" height="39" /></p>
	    </div>
	  <div align="left"></div></td>
    <td width="100" height="20"><strong>Şube Kodu</strong></td>
    <td width="3" height="20"><strong>:</strong></td>
    <td width="291" height="20">007</td>
  </tr>
  <tr>
    <td height="20"><strong>Şube Adı </strong></td>
    <td height="20"><strong>:</strong></td>
    <td height="20">Kayseri / Merkez Şubesi </td>
  </tr>
  <tr>
    <td height="20"><strong>Hesap Numarası </strong></td>
    <td height="20"><strong>:</strong></td>
    <td height="20"> 0257536 </td>
  </tr>
  <tr>
    <td height="20"><strong>Alıcı Adı </strong></td>
    <td height="20"><strong>:</strong></td>
    <td height="20">Aziz HALAT </td>
  </tr>
  <tr>
    <td height="18" colspan="5"><hr size="1"></td>
    </tr>
  <tr>
    <td width="158" height="12" rowspan="3"><img src="resimler/pttbanka.gif" width="110" height="50" /></td>
    <td height="20"><strong>Şube Adı </strong></td>
    <td height="20"><strong>:</strong></td>
    <td height="20">Kayseri / Merkez PTT Şubesi </td>
    <td width="3" height="49" rowspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td height="20"><strong>Hesap Numarası </strong></td>
    <td height="20"><strong>:</strong></td>
    <td height="20"> 5621396 </td>
  </tr>
  <tr>
    <td height="20"><strong>Alıcı Adı </strong></td>
    <td height="20"><strong>:</strong></td>
