...
<form action="edeskaydet.asp" method="post"><table width="571" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr bgcolor="#DF5A0B">
    <td colspan="3"><div class="style1" id="winhosting">
      <div align="center" class="style2">Yeni E-Destek Mesajı </div>
    </div></td>
    </tr>
    <tr>
      <td width="271"><div align="center" class="style1">
        <div align="right">Departman:</div>
      </div>        </td>
      <td width="300"><select name="departman" size="1">
        <option value="Windows Hosting">Windows Hosting</option>
        <option value="Bayi Hosting">Bayi Hosting</option>
        <option value="Alan Adı (Domain)">Alan Adı (Domain)</option>
        <option value="Satış &amp; Sipariş">Satış &amp; Sipariş</option>
        <option value="Genel" selected="selected">Genel</option>
      </select></td>
    </tr>
    <tr>
      <td height="0" class="style1"><div align="right">Öncelik:</div></td>
      <td height="0"><select name="oncelik" size="1">
        <option value="Düşük" selected="selected">Düşük</option>
    ...
    <tr>
      <td height="1" class="style1"><div align="right">Konu:</div></td>
      <td height="1"><input type="text" name="baslik" /></td>
    </tr>
    <tr>
      <td height="1" class="style1"><div align="right">Mesaj:</div></td>
      <td height="1"><textarea name="aciklama"></textarea></td>
    </tr>
    <tr>
      <td class="style1"><div align="right">
        <input type="submit" name="Submit" value="Formu Temizle" />
      </div></td>
      <td class="style1"><input type="submit" name="Submit2" value="Mesajı Gönder" /></td>
    </tr>
</tbody></table></form>
	<br>
<br>
