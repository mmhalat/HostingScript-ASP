...
sql = " Select * from paketler where paketid=" & id
...
%>
<form action="odendi.asp" method="post" name="formum">
<table width="571" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr bgcolor="#DF5A0B">
    ...
    <tr>
      <td height="18" colspan="3"><div align="right">Hizmet Adı : </div></td>
      <td height="18" colspan="2"><%=ekle("paketadi")%><input name="hizmetadi" type="hidden" value="<%=ekle("paketadi")%>"></td>
    </tr>
    <tr>
      <td height="9" colspan="3"><div align="right">Ödenecek Tutar: </div></td>
      <td height="9" colspan="2"><%=ekle("odenentutar")%><input name="odeid" type="hidden" value="<%=ekle("paketid")%>"></td>
    </tr>
    <tr>
      <td height="17" colspan="3"><div align="right">Yönlenmesini İstediğiniz Domain: </div></td>
      <td height="17" colspan="2"><input name="yondom" type="text" id="yondom" maxlength="25" />
        Max:25 Karakter (Örn:<span class="style3">ayyildizsoft.com</span> ) </td>
    </tr>
    <tr>
      <td height="18" colspan="3"><div align="right">Ödenen Tutar: 
    ...
    <tr>
      <td height="21" colspan="3"><div align="right">Banka:</div></td>
    ...
    <tr>
      <td height="18" colspan="3"><div align="right">Ödeme Yapanın Adı Soyadı: 
    ...
    <tr>
      <td height="25" colspan="3"><div align="right">Açıklama:
            
    </div></td>
      <td width="141" height="25"><textarea name="aciklama">
</textarea>
      </td>
      <td width="184">Süre Uzatması İse Lütfen Belirtiniz. </td>
    </tr>
    <tr>
