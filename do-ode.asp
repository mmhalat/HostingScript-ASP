...
%>
<form action="do-odendi.asp" method="post" name="formum">
<table width="571" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr bgcolor="#DF5A0B">
    ...
    <tr>
      <td width="248" height="18"><div align="right">Hizmet Adı : </div></td>
      <td height="18" colspan="2"><%=ekle("domainadi")%><input name="hizmetadi" type="hidden" value="<%=ekle("domainadi")%>"></td>
    </tr>
    <tr>
      <td height="9"><div align="right">Ödenecek Tutar: </div></td>
      <td height="9" colspan="2"><%=ekle("odenentutar")%><input name="odeid" type="hidden" value="<%=ekle("id")%>"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="25"><div align="right">Açıklama:
            
    </div></td>
      <td width="141" height="25" colspan="-1"><textarea name="aciklama">
</textarea>
        </td>
      <td width="182">Süre Uzatması İse Lütfen Belirtiniz. </td>
    </tr>
    <tr>
