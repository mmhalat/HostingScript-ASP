...
odemetipi = temizle(Request.Form("select"))
...
STROdemetutari = "12 YTL"
elseif odemetipi = "3aylik" then
STROdemetutari = "30 YTL"
else
STROdemetutari = "120 YTL"
end if
...
<%
if odemetipi = "Aylik" then
STROdemetutari = "8 YTL"
elseif odemetipi = "3aylik" then
STROdemetutari = "20 YTL"
else
STROdemetutari = "80 YTL"
end if
if alan_secim = "1" then
odeme.addnew
...
<table width="555" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="98"><div align="center">Tebrikler!! , Siparisiniz Sisteme Basariyla Kayıt Edildi.<br>
        ...
        <br />
Siparişiniz için teşekkür ederiz. Ödemenizin ardından siparişiniz aktif edilecektir. Ödemeniz gereken tutar <strong><%=idcek("odenentutar")%>&nbsp;</strong>'dir. <br />
<br />
...
objMessage.Subject = "AyyildizSoFT | Siparişleriniz..."
objMessage.From = "metin.halat@gmail.com"
objMessage.To = mussec("email")
objMessage.TextBody = "Mesaj"
objmessage.CreateMHTMLBody =("http://ayyildizsoft.com/HTML/1.html")
...
objMessage.Configuration.Fields.Item _
("http://schemas.microsoft.com/cdo/configuration/sendusername") = "metin.halat@gmail.com"

objMessage.Configuration.Fields.Item _
("http://schemas.microsoft.com/cdo/configuration/sendpassword") = "/*-+<<1596<</*-+"
