...
<table width="555" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#DF5A0B"><div align="center" class="style1 style2">Yasak</div></td>
  </tr>
  <tr>
    <td height="98">
	
	
	  <div align="center">Bu Alana Ulasabilmek Icin Sitemizin Müşterisi Olmalısınız, <a href="musteriol.asp">Müşteri Olmak</a> İçin Sağ Üst Köşedeki <a href="musteriol.asp">Müşteri OL</a> Butonuna Tıklayabilir, Formu Doldurduktan Sonra Gerekli İşlemleri Yapabilirsiniz... </div></td>
  </tr>
</table>
<br>
<br>
