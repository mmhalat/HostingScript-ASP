...
<table width="679" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="153" class="style1">Aktivasyon Tarihi </td>
    <td width="107" class="style1"><div align="center">Islem</div></td>
  </tr>
  			<%
			Set ekle = Server.CreateObject ("ADODB.RecordSet")
			sql = " Select * from reseller order by paketid desc"
    ...
    <td width="153"><%=ekle("aktifolmatarihi")%></td>
    <td width="107"><div align="center"><a href="ronayver.asp?id=<%=ekle("paketid")%>">Onay Ver</a> - <a href="rsil.asp?id=<%=ekle("paketid")%>">Sil </a></div></td>
  </tr>
	    <%ekle.movenext%>
