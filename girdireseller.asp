...
<table width="508" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="5" colspan="5"><div id="winhosting"><img src="resimler/aktif.gif" />&nbsp;&nbsp;<img src="resimler/yardim.png" class="Tips2" title="Aktif Reseller Paketleri::Ödemesi Yapılmış Reseller Paketleri Listeleniyor,Hiç Ödeme Yapmadi İseniz Boş Olacaktır."></div></td>
    </tr>
    <tr>
      <td colspan="5"><img src="resimler/yatay-cizgi.png" width="500" height="3" /></td>
      </tr>
    <tr>
      <td><span class="style1">Reseller Paket Adı </span></td>
...
sql="SELECT * FROM reseller WHERE onayid=" & session("uyeid") & " and paketonay=true"
...
%>
    <tr>
      <td width="125"><%=eklerim("paketadi")%></td>
...
<table width="508" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="9" colspan="5"><div id="winhosting"><img src="resimler/aktifbekleyen.gif" /><img src="resimler/yardim.png" class="Tips2" title="Ödeme Bekleyen Reseller Paketleri::Siparişini Verdiğiniz Ama Henüz Ödemesini Yapmadığınız Reseller Paketleri Listeleniyor, Banka Hesaplarımızdan Herhangi Birine 'Ödenecek Tutar' ı Havale Ettikten Sonra 'Ödeme Bildirimi' Yapiniz,Ödemeniz Onaylandığı Takdirde Reseller Paketiniz Personelimiz Tarafından Aktif Hale Getirilecek Ve Mail Adresinize Gerekli Bilgiler Gönderilecektir."></div></td>
    </tr>
    <tr>
      <td colspan="5"><img src="resimler/yatay-cizgi.png" width="500" height="3" /></td>
      </tr>
...
%>
    <tr>
      <td width="125"><%=eklerim2("paketadi")%></td>
      <td width="125"><%=eklerim2("odenentutar")%> YTL </td>
      <td width="125"><%=eklerim2("tescilsuresi")%></td>
      <td width="133"><a href="resode.asp?id=<%=eklerim2("paketid")%>">Ödeme Bildirimi Yap</a></td>
    </tr>
	<%eklerim2.movenext%>
<%next%>
